...
void xtaskmotor(void *pvParameter) {
	...
	spi_dev6100 = tmc_spi_init_6100();

//	vTaskDelay(250 / portTICK_RATE_MS);

	tmc_gpio_config(PORT_GPIO_DRV_ENN, PORT_GPIO_CONFIG_OUTPUT);
	tmc_gpio_write(16,true);

//	tmc_gpio_config(27, 1);
//	tmc_gpio_write(27,false);


//	spi_bus_remove_device(spi_dev6100);
...
//	Evalboards.ch1.enableDriver(DRIVER_ENABLE);
	...
	printf("Lo tenemos que hacer funcionar!!\r\n");
...
//	" configure TMC4671 for a BLDC motor in open loop mode"
	...
	Evalboards.ch1.writeRegister(0,0x1B, 0x00030004);
	Evalboards.ch1.writeRegister(0,0x17, 0x00000000);
	Evalboards.ch1.writeRegister(0,0x18, 0x00000F9F);
	Evalboards.ch1.writeRegister(0,0x19, 0x00001414);
	Evalboards.ch1.writeRegister(0,0x1A, 0x00000007);


	//" ADC configuration "
	Evalboards.ch1.writeRegister(0,0x0A, 0x24000100);
	Evalboards.ch1.writeRegister(0,0x04, 0x00100010);
	Evalboards.ch1.writeRegister(0,0x05, 0x20000000);
	Evalboards.ch1.writeRegister(0,0x06, 0x00000000);
	Evalboards.ch1.writeRegister(0,0x07, 0x014E014E);
	Evalboards.ch1.writeRegister(0,0x09, 0xFF00826D);
	Evalboards.ch1.writeRegister(0,0x08, 0xFF0081F8);


	//" Open loop settings "
	Evalboards.ch1.writeRegister(0,0x1F, 0x00000000);
	Evalboards.ch1.writeRegister(0,0x20, 0x00000100);


	//" Feedback selection "
	Evalboards.ch1.writeRegister(0,0x52, TMC4671_PHI_E_OPEN_LOOP);
	Evalboards.ch1.writeRegister(0,0x24, 2000);


	//" ===== Open loop test drive ===== "

	//" Switch to open loop velocity mode "
	Evalboards.ch1.writeRegister(0,0x63, TMC4671_MOTION_MODE_UQ_UD_EXT);
	...
	printf("rotate right...\r\n");
	Evalboards.ch1.writeRegister(0,0x21, 100);
...
//	vTaskDelay(1000 / portTICK_RATE_MS);
	...
	//" Stop "
//	printf("stop...\r\n");
//	Evalboards.ch1.writeRegister(0,0x21, 0);
//	vTaskDelay(1000 / portTICK_RATE_MS);

	//" unpower "
//	printf("unpowered...\r\n");
//	Evalboards.ch1.writeRegister(0,0x24, 0);
...
//		Evalboards.ch1.writeRegister(0,0x66, 	0x00000FA0); 		// writing value 0x00000000 = 0 = 0.0 to address 70 = 0x66(PID_VELOCITY_TARGET)-----------------------> Velocity Target  4000 rpm
		...
		//Evalboards.ch1.writeRegister(0, 0x66, 1800);
